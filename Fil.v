...
Section First_inductive_lemmas.
   ...
   intros H' H'0 X H'1; elim H'1; auto with v62.
   ...
   generalize (Upper_downward_stable U D A (Union U (Singleton U x) A) maj);
    ...
    [ intro H'6; lapply H'6;
       [ intro H'7; lapply H'7;
          ...
          | clear h H'6 ]
       | clear h ]
    | clear h ]; auto 10 with v62.
   lapply H'3;
    [ intro H'6; lapply H'6;
       [ intro H'7; clear H'3 H'6 | exists maj; clear H'3; try assumption ]
    | idtac ]; auto 10 with v62.
   elim H'7; intros bsup E0; clear H'7; try exact E0; auto 10 with v62.
   generalize (H'0 x bsup); intro h; lapply h;
    [ intro h0; elim h0; intros bsup0 E1; clear h h0; try exact E1
    | clear h ]; clear H'0.
   exists bsup0; apply Lub_definition; auto 10 with v62.
   elim E1; intros H'3 H'6.
   elim H'3; intros H'7 H'8.
   apply Upper_Bound_definition; auto 10 with v62.
   intros y H'10; elim H'10.
   intros x0 H'11; elim H'11; auto 10 with v62.
   intros x0 H'11; auto 10 with v62.
   generalize Rel_of_transitive; intro RoT; red in RoT.
   apply RoT with bsup; auto with v62.
   elim E0.
   intro H'12; elim H'12; auto with v62.
   elim E1.
   intros H'3 H'6 y H'7.
   apply H'6.
   elim H'7; intros H'8 H'10.
   apply Upper_Bound_definition; auto with v62.
   intros y0 H'11; elim H'11; auto 10 with v62.
   elim H'7.
   elim E0; auto 10 with v62.
   red in |- *.
   elim H'9.
   intros H'0 H'3; exists maj; intros H'6 H'7; split;
    [ idtac | apply Upper_Bound_definition ]; auto 10 with v62.
   intros y H'10; elim H'10; auto 10 with v62.
   elim E; auto 10 with v62.
   elim E0; auto 10 with v62.
   Qed.
   ...
   2: apply Definition_of_Directed; auto 10 with v62.
   2: red in |- *; auto 10 with v62.
   2: intros x H'; elim H'; auto 10 with v62.
   2: intros x0 h; elim h; intros H'3 h0; elim h0; intros H'5 H'8; clear h h0;
       elim H'8; auto 10 with v62.
   2: intro H'9; elim H'9; auto 10 with v62.
   2: apply Non_empty_intro with bsup.
   2: red in |- *; auto 10 with v62.
   2: exists (Empty_set U); split;
       [ idtac | split; [ try assumption | idtac ] ]; 
       auto 10 with v62.
   2: intros x1 x2 H'; red in H'; auto 10 with v62.
   2: unfold In at 1 in |- *.
   ...
   3: apply Upper_downward_stable with X; auto with v62.
   ...
   2: generalize (H'19 bsup0); intro h; lapply h;
       ...
       auto 10 with v62.
   2: apply Upper_Bound_definition; auto 10 with v62.
   2: elim H'2; auto 10 with v62.
   2: intros y H'20; elim H'20; auto 10 with v62.
   elim H'; intros bsup0 E0; clear H'; try exact E0; auto 10 with v62.
   ...
   generalize
    ...
    | clear h ]; auto 10 with v62.
   red in |- *.
   intros x H'; red in H'; auto 10 with v62.
   elim H'; intros Y h; elim h; intros H'3 h0; elim h0; intros H'5 H'8;
    clear H' h h0; try exact H'8; auto 10 with v62.
   apply Lub_is_in_Carrier with Y; auto with v62.
   elim E0; intros H'3 H'5; clear E0.
   elim H'3; intros H'8 H'9; clear H'3.
   intros y H'; apply H'9; auto 10 with v62.
   red in |- *;
    (exists (Singleton U y); split;
      [ idtac | split; [ try assumption | idtac ] ]); 
    auto 10 with v62.
   red in |- *; (intros x H'3; elim H'3); auto 10 with v62.
   intros y H'; try assumption.
   elim E0; intros H'3 H'5; clear E0; apply H'5.
   apply Upper_Bound_definition; auto 10 with v62.
   elim H'; auto 10 with v62.
   intros y0 H'8; red in H'8; auto 10 with v62.
   elim H'8; intros Y h; elim h; intros H'9 h0; elim h0; intros H'10 H'11;
    clear H'8 h h0; try exact H'11; auto 10 with v62.
   elim H'11; intros H'8 H'12; clear H'11.
   apply H'12; auto 10 with v62.
   apply Upper_downward_stable with X; auto with v62.
   Qed.
