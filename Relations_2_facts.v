...
intros U R; red in |- *; intros x y H'; apply Rstar_n with y; auto with v62.
Qed.
...
intros U R; red in |- *.
intros x y H'; elim H'.
generalize Rstar_contains_R; intro T; red in T; auto with v62.
intros x0 y0 z H'0 H'1 H'2; apply Rstar_n with y0; auto with v62.
Qed.
...
intros x0 y0 z0 H'0 H'1 H'2 H'3; apply Rstar_n with y0; auto with v62.
Qed.
...
intros x0 y0 z H'0 H'1 H'2; right; exists y0; auto with v62.
Qed.
...
intros x0 y0 z H'0 H'1 H'2 H'3; apply T1 with y0; auto with v62.
intros x0 y0 z H'0 H'1 H'2; apply Rstar1_n with y0; auto with v62.
Qed.

Theorem Rsym_imp_Rstarsym :
 forall (U : Type) (R : Relation U), Symmetric U R -> Symmetric U (Rstar U R).
intros U R H'; red in |- *.
intros x y H'0; elim H'0; auto with v62.
...
unfold contains in |- *.
intros U R S H' x y H'0; elim H'0; auto with v62.
generalize Rstar_transitive; intro T; red in T.
intros x0 y0 z H'1 H'2 H'3; apply T with y0; auto with v62.
Qed.
...
intros x0 a H'1; exists a; auto with v62.
