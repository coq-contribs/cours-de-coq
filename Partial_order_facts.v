...
Section Lemmas_on_partial_orders.
   ...
   intros x y H' H'0; red in |- *; auto 20 with v62.
   intros x0 H'1; elim H'1; auto 20 with v62.
   Qed.
   ...
   intros bsup X H' H'0; elim H'0; auto 20 with v62.
   intro H'1; elim H'1; auto 20 with v62.
   Qed.
   
   Theorem Singleton_has_lub :
    forall x : U, In U (Carrier_of U D) x -> Lub U D (Singleton U x) x.
   intros x H'; auto 20 with v62.
   apply Lub_definition; auto 10 with v62.
   apply Upper_Bound_definition; auto 10 with v62.
   intros y H'0; elim H'0; auto 10 with v62.
   intros y H'0; elim H'0; auto 10 with v62.
   Qed.
   ...
   intros H'1 H'2; exists bsup; apply Bottom_definition; auto 10 with v62.
   elim H'1; auto 10 with v62.
   intros y H'3; try assumption; auto 10 with v62.
   apply H'2; auto 10 with v62.
   apply Upper_Bound_definition; auto 10 with v62.
   intros y0 H'4; elim H'4; auto 10 with v62.
   Qed.
   ...
   intros x y; apply Extensionality_Ensembles; apply Same_set_intro;
    red in |- *; (intros x0 H'; elim H'); auto 10 with v62.
   Qed.
   ...
   elim Couple_is_symmetric; exists z; auto with v62.
   Qed.
