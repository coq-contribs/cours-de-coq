...
intros U R H' x y H'0; red in |- *; intro H'1; apply H'0; auto with v62.
Qed.
...
red in H'0; auto 10 with v62.
2: red in |- *; intros x y h; elim h; intros H'3 H'4; auto 10 with v62.
red in H'1; red in |- *; auto 10 with v62.
intros x y z h; elim h; intros H'3 H'4; clear h.
intro h; elim h; intros H'5 H'6; clear h.
split; apply H'1 with y; auto 10 with v62.
Qed.
...
intros U R H'; elim H'; auto 10 with v62.
Qed.
...
unfold same_relation at 1 in |- *; auto 10 with v62.
Qed.
